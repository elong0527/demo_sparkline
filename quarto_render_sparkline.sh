...
# Script to render Quarto document and add essential libraries at the beginning
...
}
{
    ...
    if (/<script/ && !scripts_inserted) {
        print "<!-- Essential libraries loaded first -->"
...
echo "✓ Complete! $HTML_FILE has been rendered with essential libraries loaded first."